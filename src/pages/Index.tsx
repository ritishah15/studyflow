        ...
        <div className="container space-y-3">
          <div className="flex items-center justify-between text-sm text-muted-foreground">
            <div className="flex items-center gap-2">
              ...
              <span className="font-medium gradient-text">StudyFlow AI</span>
            </div>
          ...
          <div className="text-center text-xs text-muted-foreground/50 border-t border-border/30 pt-3">
            © 2026 StudyFlow AI. All rights reserved. Unauthorized use or reproduction is prohibited.
          </div>
        </div>
      </footer>
    </div>
